...
const all: Product[] = [
  ...
  // in the catalog, the Software family, contact and support.
  {
    ...
    resources: [],
    images: [
      { src: "/images/bac/app-preview.webp", alt: "BORGAS Asset Creator Preview screen showing a generated, textured wood-handled axe with 238,708 triangles and 4096-pixel textures", caption: "BAC Preview screen with a model generated by BAC from four reference images. Actual application screenshot." },
